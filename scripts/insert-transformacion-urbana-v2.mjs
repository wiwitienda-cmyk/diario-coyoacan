...
const content = `Coyoacán vive una intensa transformación urbana que abarca desde operativos de seguridad nocturna hasta la implementación de programas de sustentabilidad y renovación de espacios públicos, en vísperas del Mundial de Futbol 2026. En una semana marcada por la intervención de más de 8 mil viviendas y la desarticulación de una fiesta clandestina con más de mil asistentes, las autoridades buscan consolidar un entorno seguro y sostenible para sus habitantes.

## Operativo nocturno desmantel--snip--a fiesta clandestina
...
No obstante, la desarticulación de fiestas clandestinas con alta concurrencia y consumo de alcohol entre menores evidencia que la seguridad sigue siendo un desafío que requiere vigilancia constante y acciones preventivas. En este sentido, la ampliación de la infraestructura verde y la mejora en la iluminación pública contribuyen a crear entornos más seguros y habitables.
...
**Fuentes:** El Universal (15 feb 2026), La Jornada (22 feb 2026), El Heraldo de México (22 feb 2026), Secgob CDMX`;

const articleData = {
  slug: 'coyoacan-impulsa-seguridad-y-sustentabilidad-en-transformacion-urbana-2026-02-24',
  title: 'Coyoacán impulsa seguridad y sustentabilidad en transformación urbana rumbo a Mundial 2026',
...
try {
  ...
  console.log('✅ Artículo insertado exitosamente en newsArticles');
